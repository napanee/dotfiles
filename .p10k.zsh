# Generated by Powerlevel10k configuration wizard on 2023-08-05 at 16:22 CEST.
...
() {
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND='#303030'
  typeset -g POWERLEVEL9K_NVM_BACKGROUND='#68A063'
